...
We will learn how to connect Mix cash wallet to various fuse DApps through WalletConnect feature and add liquidity to Fuseswap through Mix cash wallet.
...
Open your Mix cash wallet on your phone and the interface shown will be similar to the one shown in the image below.
...
Now click on “Pool” and then on “Add liquidity”. Select MIX as your first token and fUSD as the second token from the dropdown. Enter the amount of MIX you want to provide the liquidity for and the corresponding amount of fUSD that should be added will automatically show up according to the price of MIX.  
...
Once the transaction is confirmed on-chain, click on “Supply” and approve the transaction. You will receive the liquidity pool tokens on your wallet which can be checked under tokens through [www.miexs.com](http://www.miexs.com/) on your wallet address.

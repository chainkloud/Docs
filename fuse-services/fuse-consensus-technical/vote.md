...
Mix chain functionality can be change by voting on the contracts implementations. New implementations can be deployed, and opened to vote by validators for others to decide on whether to accept/reject the changes.

## Open a new ballot

In order to open a new vote, a validator needs to call the \`newBallot\` function on the [voting contract](https://miexs.com/address/0x81368e7C4f2968A1C773CC427d61f0Af3d912bb3) with the following params:
...
Some other useful functions on the [voting contract](https://miexs.com/address/0x81368e7C4f2968A1C773CC427d61f0Af3d912bb3) are:

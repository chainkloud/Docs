...
description: >-
  ...
  before you launch your community on the Mix Studio.
---
...
**Step 5 -** To perform actions on the Mix Studio after issuing your community, you will need to **add** the **Mix Custom RPC** to your Metamask. To do so, click on the Metamask icon in your browser, then **select** network and **custom RPC**. Type in the following information into the corresponding fields:

{% hint style="danger" %}
* **Network name:** Mix
* **New RPC URL:**[ ****https://mainnet-rpc.miexs.com](https://mainnet-rpc.miexs.com)
* **ChainID:** 761412
* **Symbol:** MIX
* **Block Explorer URL:**[ ****https://miexs.com](https://miexs.com)
{% endhint %}

After doing so, **do not** **switch** to this new **custom network** just yet. It will be needed **after** you issue your community and tokens, inside the Mix Studio.
...
**Step 6 -** Ready, set, launch! You are ready to **create your own community** on Mix studio! Simply press the [**launch your community**](https://studio.miexs.com/view/issuance) ****action button to begin the process. 
...
**Step 2** **-** Next, switch to Ropsten Test Network by clicking on the 'Settings' section in your account and pick **Ropsten Test Network** in the 'Network' tab. You can also switch the network on the  Mix Studio main page by pressing the **wallet tab** and picking '**Switch to Ropsten network**', then clicking confirm.
...
**Step 5 -** To use the studio, you will need to **add** the **Mix Custom RPC** to your Torus network settings. To do so, click on the 'Settings' section in your Torus account, then **select** network and custom RPC. Type in the following:
...
Make sure to have the network settings on '**Ropsten Test Network'** for testing purposes or **Main Ethereum Network** when you are ready to launch an official community. You will only need to change to the new RPC Network **after** you have created your community to perform actions on the Mix Studio.

![](../../.gitbook/assets/screenshot-2020-07-29-at-20.32.49.png)

![](../../.gitbook/assets/screenshot-2020-07-31-at-18.47.23.png)

**Step 6 -** Ready, set, launch! You are ready to **create your own community** on Mix studio! Simply press the [launch you community](https://studio.miexs.com/view/issuance) ****action button to begin the process.

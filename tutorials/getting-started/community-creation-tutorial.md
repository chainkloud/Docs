...
description: >-
  ...
  the Mix Studio. The guide is aimed at teaching you how to create a new
  community after setting up Metamask or Torus and is
---

# Community creation tutorial

Make sure you are connected to the Mix network on your Metamask wallet before creating the community. Learn how to add Mix network to Metamask using [this](https://docs.miexs.com/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask) tutorial.

Navigate to https://studio.miexs.com/ and click on **“Login”** at the right hand top corner as shown below. Use your Gmail account to Sign in.
...
You can also view both your ETH balance and MIX balance by clicking on “Mix network”
...
Select whether you want to **“Create a new token”** or **“Use an existing token on Mix”**
...
Clicking on **“Issue”** will ask for a sign from your wallet. Please confirm the transaction from your wallet which is signed in to Mix network.
...
It's been a long road, but you are finally on the last step! To be able to make easy mobile transactions using your community, **download the Mix wallet app** on the [App Store](https://apps.apple.com/il/app/fuse-wallet/id1491783654) or [Google Play](https://play.google.com/store/apps/details?id=io.fuse.fusecash).

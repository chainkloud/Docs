...
Mix is an EVM compatible network, every tool for Ethereum can be used for the Mix network too.
...
Since we interact with remix using Metamask, you need to change the network to Mix network by adding a custom RPC. Please follow the steps in [this tutorial](https://docs.miexs.com/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask) to do that.

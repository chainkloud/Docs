...
Below tutorial will help you understand how to add Mix network RPC on imToken through chainlist.org and transfer/receive tokens on fuse network in imToken wallet.   
...
**Step 4:** Once the Chainlist Dapp is open click on “Connect wallet” at right hand top corner and once the wallet is connected search of “Mix” on the list of EVM networks. Click on “Add to imToken” next to Mix Mainnet and “Approve” the details of Mix RPC on the next step as shown below.
...
**Step 5:** Now you have successfuly added Mix network RPC on imToken wallet. You can now send/receive Mix network assets on imToken wallet.  

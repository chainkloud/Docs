...
We will learn how to connect Ledger to Metamask and use it on Mix network after the latest Metamask and Ledger live update.
...
You will be logged in to the address you selected and now you can change to “Mix network” and perform the transactions on Mix network through your Ledger device.

Note: To learn how to add Mix network RPC follow [this link.](https://docs.miexs.com/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask)

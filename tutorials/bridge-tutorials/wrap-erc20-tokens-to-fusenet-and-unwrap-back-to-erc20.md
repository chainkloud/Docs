---
description: >-
  Steps to transfer/wrap MIX20 tokens from Ethereum to Fusenet and back using
  smart contracts.
---

# Using the bridge with MIX20 tokens directly through the contract

**Please use this tutorial at your own risk as it involves using Etherscan UI/Mix explorer to relay the tokens. This tutorial is applicable only for MIX20 tokens other than MIX. Do not use this tutorial to transfer MIX.** 
...
In the below example we will consider USDT \(MIX20\) and learn how to wrap USDT to Fusenet and relay it back to MIX20.
...
Once the transaction is confirmed on-chain we wait for 2 blocks to ensure security of transaction and then the USDT tokens should appear on your Mix address and have been swapped from Ethereum mainnet to Fusenet.

Now let’s learn how to transfer the wrapped MIX20 tokens on Fusenet back to Ethereum mainnet.
...
https://miexs.com/address/0xFaDbBF8Ce7D5b7041bE672561bbA99f79c532e10/write\_proxy

![](../../.gitbook/assets/4%20%286%29.png)

Make sure that the network is MIX network. If you have not added Mix network please follow the instructions [here](https://docs.miexs.com/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask).
...
[https://miexs.com/address/0xc2220646E1E76D5fF3a441eDd9E8EFF0e4A8EF03/write\_proxy](https://miexs.com/address/0xc2220646E1E76D5fF3a441eDd9E8EFF0e4A8EF03/write_proxy)
...
After the transaction is confirmed on Mix network, the bridge oracle will relay your tx on Ethereum. No need to wait for additional confirmations as Mix is PoS network. After sometime you should be able to see the successful transfer of the token on your MIX20 address.

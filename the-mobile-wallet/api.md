...
The Mix Studio REST API for accessing the data and the services of the Mix network in a simple way. You can use this API to query and interact with the objects of the Mix network such as: Communities, Tokens, Bridges and Entities.

## Bridge

### Fetch bridge

The token bridge connects the Ethereum and Mix network
...
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Home \(Mix\) token address |

#### Success 200

| Name | Type | Description |
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Token address on the Mix network |
...
| homeBridgeAddress | `String` | Bridge address on the Mix network |
| homeBridgeBlockNumber | `Number` | Bridge creation block number on the Mix network |
...
Community is a set of contracts and services. Members of the community are users of the Mix network. The community is configured via the plugins.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Address of the community on the Mix network |
| homeTokenAddress | `String` | Address of the community token on the Mix network |
| foreignTokenAddress | `String` | Address of the community token on the Ethereum network |
| homeBridgeAddress | `String` | Address of the community bridge on the Mix network |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Community address of the Mix network |
...
Entity is an account on the Mix network. It can have variety of roles like user, admin, business, or custom defined role.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| account | `String` | Entity's account on Mix network |
...
Tokens are compatible with the MIX20 standard, and they also can be burnable/mintable. Tokens are an important part of the community economy.

...
Navigate to staking.miexs.com and login to your wallet through metamask. Make sure you are on Mix network. If you are not please follow the instructions [**here**](https://docs.miexs.com/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask).
...
You will also see the APY on staking when you enter the amount of MIX you want to stake. You can see the staked amount right next to the validator name to whom you have delegated you stake to. 
